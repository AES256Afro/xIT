...
| What | Where |
|---|---|
| Chrome package | `dist/xit-chrome-1.0.1.zip` |
| Firefox package | `dist/xit-firefox-1.0.1.zip` |
...
1. Pay the one-time **US$5** developer registration at
   ...
   before this clears.
2. **New item** → upload `dist/xit-chrome-1.0.1.zip`.
...
3. Upload `dist/xit-firefox-1.0.1.zip`.
