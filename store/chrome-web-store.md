...
Upload: `dist/xit-chrome-1.0.0.zip`
...
1. **Broad optional host permissions.** `*://*/*` in `optional_host_permissions`
   ...
   above is the honest explanation — custom self-hosted instances cannot be
